...
public class DesktopTerrier extends JFrame {
	...
	//private static String mModel = ApplicationSetup.getProperty("desktop.matching","OldBasicMatching");
        //private static String wModel = ApplicationSetup.getProperty("desktop.model", "PL2");
	//private static String wModel = ApplicationSetup.getProperty("desktop.model", "BM25");
	//private static String wModel = ApplicationSetup.getProperty("desktop.model", "DFI0");
        //private static String wModel = ApplicationSetup.getProperty("desktop.model", "DFR_BM25");
        //private static String wModel = ApplicationSetup.getProperty("desktop.model", "DFRee");
        //private static String wModel = ApplicationSetup.getProperty("desktop.model", "DLH");
        //private static String wModel = ApplicationSetup.getProperty("desktop.model", "DirichletLM");
        //private static String wModel = ApplicationSetup.getProperty("desktop.model", "Hiemstra_LM");
        //private static String wModel = ApplicationSetup.getProperty("desktop.model", "MeuDFI0");
        private static String wModel;
        private List<String> folderList;
	private Manager queryingManager;
	private Index diskIndex;
	
        KnowledgeAreas ka = new KnowledgeAreas();
	...
	private JButton jButton2 = null;
        ...
        private static JComboBox jComboPerfil = null;
        private static JComboBox jComboRankClass = null;
	
        
        /**
         * inicializa combobox do perfil
         * @return javax.swing.JCombobox
         */
        private JComboBox getJComboPerfil(){
            if(jComboPerfil == null){
                jComboPerfil = new JComboBox();
                jComboPerfil.setModel(new javax.swing.DefaultComboBoxModel(new String[] {"Selecione um Perfil", "Nenhum Perfil", "Engenharia Automotiva", "Engenharia Eletronica", 
            "Engenharia de Energia", "Engenharia de Software"}));
            }
            return jComboPerfil;
        }
        
        /**
         * pega o indice da combobox do perfil para servir de parametro para classificacao
         * 
         * @return indice do combobox 
         */
        public static int pegaIndicePerfil(){
            return jComboPerfil.getSelectedIndex();
        }
        
        /**
         * inicializa combobox dos algoritmos de ordenacao
         * @return javax.swing.JCombobox
         */
        public static JComboBox getJComboRankClass(){
        ...
        /**
         * pega indice da combobox do tipo de categorizacao para servir de parametro para escolha da classe
         * 
         * @return indice da combo
         */
        public static int pegaIndiceRank(){
            return jComboRankClass.getSelectedIndex();
        }
        
        

    /**
     * alocando a variavel wModel
     */
    public static String allocateWModel() {
        
        switch(pegaIndiceRank()){
            case 0:
                return DesktopTerrier.wModel = ApplicationSetup.getProperty("desktop.model", "MeuDFI0");    
            
            case 1:
                return DesktopTerrier.wModel = ApplicationSetup.getProperty("desktop.model", "MeuPL2");
                
            case 2:
                return DesktopTerrier.wModel = ApplicationSetup.getProperty("desktop.model", "MeuBM25");
	...
	private JTextField getJTextField() {
         ...
         * @return javax.swing.JTextField
         */
        public static String pegarConsulta(){
	...
	private JPanel getJPanel2() {
		if (jPanel2 == null) {
			...
			jPanel2.add(getJButton(), null);
                        //adiciona minha combobox
                        jPanel2.add(getJComboPerfil(), null);
                        jPanel2.add(getJComboRankClass(), null);
		}
		return jPanel2;
	}
	/**
		...
		if(folderList.size() == 0 && diskIndex == null)
		{
			...
			if (n == JOptionPane.YES_OPTION)
			{
				...
				jButton2.setEnabled(false);//disable index button
                                ...
                                jComboRankClass.setEditable(false);
				...
				new Thread() {
					public void run() {
						...
						jButton2.setEnabled(true);
                                                ...
                                                jComboRankClass.setEnabled(true);
					}
				} .start();
				//);
	...
	public DesktopTerrier() {
		...
		ApplicationSetup.setProperty("ignore.low.idf.terms","false");
                ApplicationSetup.setProperty("matching", "Matching");
...
//		fOpener.load();
	...
	private void runQuery() {
		...
		try {
			...
			srq.addMatchingModel(mModel, allocateWModel());
	...
	private void renderResults(ResultSet rs) throws Exception {
		...
		for (int i = 0; i < ResultsSize; i++) {
			...
			if(Rounding.toString(scores[i], 4) == "0" ){
                            rows.remove(thisRow);
                        } else{
                            rows.add(thisRow);
                        }
